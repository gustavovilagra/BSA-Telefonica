...
public interface IProjectVariables {
	...
	public static final String PC__CPF = "pc_Cpf";
	public static final String SAIDA = "saida";
	public static final String CPF_VALID = "cpfValid";
	public static final String VALOR_NOME = "valorNome";
	public static final String PHONE = "phone";
	public static final String NOME_VALID = "nomeValid";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String GENDER = "gender";
	public static final String SESSION = "session";
	public static final String CARD__NO = "card_no";
	public static final String AUDIO = "audio";
	public static final String EMAIL = "email";
	public static final String PC__CNPJ = "pc_cnpj";
	public static final String LAST__NAME = "last_name";
	public static final String DD_LAST_EXCEPTION = "ddLastException";
	public static final String CNPJ_VALID = "cnpjValid";
	public static final String ACCOUNT__ID = "account_id";
	public static final String MNS = "mns";
	public static final String CRM__ID = "crm_id";
	public static final String MENU__PESSOA = "menu_pessoa";
	...
	public static final String PC__CPF_FIELD_CONFIDENCE = "confidence";
	public static final String PC__CPF_FIELD_INPUTMODE = "inputmode";
	public static final String PC__CPF_FIELD_INTERPRETATION = "interpretation";
	public static final String PC__CPF_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String PC__CPF_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String PC__CPF_FIELD_UTTERANCE = "utterance";
	public static final String PC__CPF_FIELD_VALUE = "value";
	...
	public static final String PC__CNPJ_FIELD_CONFIDENCE = "confidence";
	public static final String PC__CNPJ_FIELD_INPUTMODE = "inputmode";
	public static final String PC__CNPJ_FIELD_INTERPRETATION = "interpretation";
	public static final String PC__CNPJ_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String PC__CNPJ_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String PC__CNPJ_FIELD_UTTERANCE = "utterance";
	public static final String PC__CNPJ_FIELD_VALUE = "value";
	...
	public static final String MENU__PESSOA_FIELD_CONFIDENCE = "confidence";
	public static final String MENU__PESSOA_FIELD_INPUTMODE = "inputmode";
	public static final String MENU__PESSOA_FIELD_INTERPRETATION = "interpretation";
	public static final String MENU__PESSOA_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MENU__PESSOA_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MENU__PESSOA_FIELD_UTTERANCE = "utterance";
	public static final String MENU__PESSOA_FIELD_VALUE = "value";
	...
	public static final String TENTATIVAS_FIELD_CNPJ = "cnpj";
	public static final String TENTATIVAS_FIELD_CPF = "cpf";
	public static final String TENTATIVAS_FIELD_MENU = "menu";
