 ...
 * Last generated by Orchestration Designer at: 20 DE FEVEREIRO DE 2023 16H23MIN44S BRT
 */
public class exit extends com.avaya.sce.runtime.Return {
	...
	public java.util.Collection getOutputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("Nome", "valorNome", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
