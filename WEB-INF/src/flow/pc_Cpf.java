 ...
 * Last generated by Orchestration Designer at: 20 DE FEVEREIRO DE 2023 17H38MIN0S BRT
 */
public class pc_Cpf extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("pc_cpf", ""));

		// build the list of grammar information objects for the field
		String ___tempGrammarName = null;
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("cpf", "1.0"));


		// build events for the field: "pc_Cpf"
		events = new java.util.ArrayList(2);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("checar_erro", 0, true, ""));
		events.add(event);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("checar_erro", 0, true, ""));
		events.add(event);
		properties = new java.util.ArrayList();

		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("pc_Cpf", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("checar_Cpf");
		return submit;
	}
	/**
