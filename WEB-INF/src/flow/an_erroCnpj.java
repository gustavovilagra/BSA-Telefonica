 ...
 * Last generated by Orchestration Designer at: 20 DE FEVEREIRO DE 2023 20H53MIN22S BRT
 */
public class an_erroCnpj extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("an_erroCnpj", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("pc_cnpj");
		return submit;
	}
	/**
