 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 20 DE FEVEREIRO DE 2023 16H19MIN15S BRT
 */
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("rd_propiertes");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.PC__CPF_FIELD_CONFIDENCE,
			IProjectVariables.PC__CPF_FIELD_INPUTMODE,
			IProjectVariables.PC__CPF_FIELD_INTERPRETATION,
			IProjectVariables.PC__CPF_FIELD_NOINPUTCOUNT,
			IProjectVariables.PC__CPF_FIELD_NOMATCHCOUNT,
			IProjectVariables.PC__CPF_FIELD_UTTERANCE,
			IProjectVariables.PC__CPF_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PC__CPF, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.SAIDA, "false", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.CPF_VALID, "false", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.VALOR_NOME, "\"\"", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.PHONE, "\"\"", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.NOME_VALID, "false", null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.GENDER, "\"\"", null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.CARD__NO, "\"\"", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.AUDIO, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.EMAIL, "\"\"", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.PC__CNPJ_FIELD_CONFIDENCE,
			IProjectVariables.PC__CNPJ_FIELD_INPUTMODE,
			IProjectVariables.PC__CNPJ_FIELD_INTERPRETATION,
			IProjectVariables.PC__CNPJ_FIELD_NOINPUTCOUNT,
			IProjectVariables.PC__CNPJ_FIELD_NOMATCHCOUNT,
			IProjectVariables.PC__CNPJ_FIELD_UTTERANCE,
			IProjectVariables.PC__CNPJ_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PC__CNPJ, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.LAST__NAME, "\"\"", null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.CNPJ_VALID, "false", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.ACCOUNT__ID, "\"\"", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.MNS, "false", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.CRM__ID, "\"\"", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.MENU__PESSOA_FIELD_CONFIDENCE,
			IProjectVariables.MENU__PESSOA_FIELD_INPUTMODE,
			IProjectVariables.MENU__PESSOA_FIELD_INTERPRETATION,
			IProjectVariables.MENU__PESSOA_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU__PESSOA_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU__PESSOA_FIELD_UTTERANCE,
			IProjectVariables.MENU__PESSOA_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU__PESSOA, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.TENTATIVAS_FIELD_CNPJ,
			IProjectVariables.TENTATIVAS_FIELD_CPF,
			IProjectVariables.TENTATIVAS_FIELD_MENU };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.TENTATIVAS, variableFields, new String[] {"0", "0", "0"}, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.USERNAME, "\"\"", null, session, false, false );
		session.putVariable(variable);
	}
	/**
